...
<body class="bg-light-gray" id="body">
    <div class="container d-flex flex-column justify-content-between vh-100">
                    ...
                    <div class="card-header bg-primary">
                        <div class="app-brand">
                            <a href="/index.html">
                                ...
                                <span class="brand-name">WEBERNET AGENCY</span>
                            </a>
                        </div>
                    </div>
                        @if (session('success'))
        ...
        <div class="copyright pl-0">
            <p class="text-center">&copy; 2023 Copyright easy Dashboard by Weberenet-agency
                <a class="text-primary" href="https://webernet.agency/" target="_blank">Weberenet-agency</a>.
            </p>
        </div>
    </div>
</body>
